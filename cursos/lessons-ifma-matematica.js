...
const modules = [
  {
    ...
    videos: [
      ...
      { title: "Conversão de unidades 1", youtubeUrl: "https://youtu.be/xCR_YNzDMsI" },
      { title: "Cálculo de média", youtubeUrl: "https://youtu.be/iUltbIYany8" },
      { title: "Aritmética 2", youtubeUrl: "https://youtu.be/yymL59CShXk" },
      { title: "Conversão de unidades 2", youtubeUrl: "https://youtu.be/0RuYHKArRVI" },
    ],
  },
  { slug: "fracoes-decimais", name: "Frações e Números Decimais", videos: [] },
  {
    ...
    videos: [
      ...
      { title: "Porcentagem 4", youtubeUrl: "https://youtu.be/bqiTxgAG6-I" },
    ],
  },
  ...
  },
  {
    ...
    videos: [
      ...
      { title: "Área e aproveitamento de folha", youtubeUrl: "https://youtu.be/MZbkwvGOoz8" },
    ],
  },
  {
...
function denyAccess() {
  ...
  if (window.F3Exatas && window.F3Exatas.showAccessDeniedModal) {
    window.F3Exatas.showAccessDeniedModal("Matemática para o IFMA");
  }
}
